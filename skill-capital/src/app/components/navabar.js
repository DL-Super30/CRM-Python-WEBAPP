            ...
            <div className="relative" key={menu}>
              ...
              {dropdownOpen[menu] && (
                <div className="absolute left-0 mt-2 w-36 sm:w-40 bg-white shadow-lg rounded-md z-10" >
                   {menu === 'Home' && (
                    <Link href="/dashboard" className="block px-4 py-2 text-gray-700 hover:bg-gray-100"></Link>
                  )}
                  {menu === 'leads' && (
                    <Link href="/leaddetails" className="block px-4 py-2 text-gray-700 hover:bg-gray-100"></Link>
                  )}
                  {menu === 'opportunities' && (
