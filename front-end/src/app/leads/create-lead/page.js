...
//         </div>
//       </header>
//       <div className="min-h-screen bg-gray-10 sm:p-6 lg:p-8 w-full shadow-lg w-full ">
//         <div className="container mx-auto p-16 bg-white rounded-lg w-full border-gray-600 shadow-lg shadow-gray-600">
...
export default function CreateLeadPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gray-10 w-full">
      ...
      <div>
        <div className="container mx-auto p-16 bg-white rounded-lg border-gray-600 shadow-lg">
          <div className="flex flex-col h-[calc(100vh-160px)]">
            ...
            <div className="overflow-y-auto">
              ...
              <div className="bottom-0 left-0 w-full py-4 shadow-md flex justify-center gap-4">
                <button onClick={handleCancel} className="bg-red-500 text-white py-2 px-4 rounded-md shadow-md text-sm sm:text-base">Cancel</button>
                <button onClick={handleCreate} className="bg-blue-500 text-white py-2 px-4 rounded-md shadow-md text-sm sm:text-base">Create</button>
              </div>
            </div>
