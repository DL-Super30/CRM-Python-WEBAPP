...
const Dashboard = () => {
  ...
  const groupData = (data) => {
    ...
    return [
      { id: 'not-contacted', title: 'Not Contacted', color: 'bg-[#FFCCCC]', leads: [] },
      { id: 'attempted', title: 'Attempted', color: 'bg-[#FFFF99]', leads: [] },
      { id: 'opportunity', title: 'Opportunity', color: 'bg-[#CCFFCC]', leads: [] },
      { id: 'cold-lead', title: 'Cold Lead', color: 'bg-[#CCCCFF]', leads: [] }
    ];
  };
